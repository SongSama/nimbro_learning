...
public:
					...
					0)
	{
		...
		//blockSolver = new BlockSolverX(linearSolver);
                blockSolver = new BlockSolverX(unique_ptr<BlockSolverX::LinearSolverType>(linearSolver) );
		
                //create the algorithm to carry out the optimization
		optimizationAlgorithm = new OptimizationAlgorithmLevenberg(unique_ptr<BlockSolverX>(blockSolver));
	}
